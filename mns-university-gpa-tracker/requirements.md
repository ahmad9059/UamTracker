...
UamTracker is a Next.js web application designed for students to track their academic progress through semester-based GPA calculations and GPA Records. The system provides both public GPA calculation tools and authenticated student dashboards with comprehensive course tracking, visual analytics, and personalized academic progress monitoring. The application implements a quality point system based on marks obtained out of different totals (20, 40, 60, 80, 100).

## Glossary

- **System**: The UamTracker web application
...
**User Story:** As a student, I want the system to automatically calculate quality points based on UamTracker's GPA Records system, so that my GPA is accurate according to supported standards.
